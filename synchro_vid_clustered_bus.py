...
"""
 ...
 Set the right vid_path, cluster_scenario_path and cam_data_path
"""
...
def main(location):
    ...
    vid_path = os.path.join("data/Camera_data", location,
                            "Front_Camera_Video/cam_front_center20180810_150607.mp4")

    camera = "cam_front_center"

    # path to clustered bus data
    # choose scenario name from results/<location>/Driving_scenarios/json_files/
    cluster_scenario_path = os.path.join("results", location, "Driving_scenarios", "json_files",
                                         "weka.clusterers.EM_K_4_scenario_1.json")
    ...
    if not os.path.exists(os.path.join("results", location, "Driving_scenarios", 'driving_scenarios_video')):
        os.makedirs(os.path.join("results", location, "Driving_scenarios", 'driving_scenarios_video'))
    vid_out = cv.VideoWriter(os.path.join(
        "results", location, "Driving_scenarios", "driving_scenarios_video", "weka.clusterers.EM_K_4_scenario_1.mp4"),
